...
--sql = { driver = "MySQL", database = "prosody", username = "prosody", password = "YOUR_PROSODY_DB_PASSWORD", host = "localhost" }
--sql = { driver = "PostgreSQL", database = "prosody", username = "prosody", password = "YOUR_PROSODY_DB_PASSWORD", host = "localhost" }
